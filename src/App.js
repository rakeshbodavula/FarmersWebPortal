    ...
    <Router>
      <div className="App">
        ...
        <Routes>
          ...
          <Route exact path = '/search/fertilizers/' element={!prod_isPending && <Market data={prod_data.filter(x=>x.category==="fertilizers")} isPending={prod_isPending} error={prod_error}/>}></Route>
          <Route exact path = '/search/seeds/' element={!prod_isPending && <Market data={prod_data.filter(x=>x.category==="seeds")} isPending={prod_isPending} error={prod_error}/>}></Route>
          <Route exact path = '/search/pesticides/' element={!prod_isPending && <Market data={prod_data.filter(x=>x.category==="pesticides")} isPending={prod_isPending} error={prod_error}/>}></Route>
