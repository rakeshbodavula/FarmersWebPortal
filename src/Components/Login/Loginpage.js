...
import { signUpSchema } from "./Schema2";
            ...
            <div className="loginform-container">
              <div className="loginform-left">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="">
                    <a href="# "><i id='icon' className="fab fa-facebook-f fa-2x px-5 mr-5"></i></a>
                    <a href="# "><i id='icon' className="fab fa-twitter fa-2x"></i></a>
                    <a href="# "><i id='icon' className="fab fa-instagram fa-2x px-5 mr-5"></i></a>
                    <a href="# "><i id='icon' className="fab fa-linkedin-in fa-2x"></i></a>
                  </div>
